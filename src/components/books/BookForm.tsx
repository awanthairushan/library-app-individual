...
const BookForm : React.FC<BookFormProps> = (props) => {
    ...
    const handleOnISBNChange = (isbn:number) => {
        setIsbn(isbn);
    }
        ...
        <Row>
            <Col lg={9} md={12} className="pe-4">
                <Row className="book_form">
                    ...
                    <h2 className="px-0 fs-3">
                        {/* {props.updateBookIndex === null ? "Create" : "Update"}  */}
                        Create Book</h2>
                    </Col>
                    ...
                    <Col className="pe-0 ms-lg-4 me-md-2">
                        <Form noValidate validated={validated} className="" id="Book_form"  onSubmit={handleSubmit}>
                            <Form.Group>
                                ...
                                <Form.Control type="text" className="form_control px-0" size="sm" required onChange={(event) => handleOnBookNameChange(event.target.value)}/>
                            ...
                            <Form.Group>
                                ...
                                <Form.Control type="number" className="form_control px-0" size="sm" required onChange={(event) => handleOnISBNChange(Number(event.target.value))}/>
                                <Form.Control.Feedback type="invalid">
                                    ISBN is required.
                                </Form.Control.Feedback>
                            </Form.Group>
                ...
                <Row className="book_form py-4 ">
                    <Col className="pe-0 d-flex justify-content-end me-md-2">
                        <Button variant="primary" className="px-4 py-1 fs-6 create_button" size="sm" type="submit" form="Book_form">
                            {/* {props.updateBookIndex === null ? "Create" : "Update"} */} Create
                        </Button>
                    </Col>
                </Row>
            </Col>
