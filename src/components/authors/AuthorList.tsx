...
type AuthorListProps = {
    authors: IAuthor[];
    handleOnUpdateAuthor: (author: IAuthor) => void
    handleOnDeleteAuthor: (deleteId: string) => void
}
                ...
                <li className="author_list_item">
                    {
                        props.authors.map((author: IAuthor, index: number) =>
                            <Author author={author} index={index} key={index}
                                    onUpdateAuthor={props.handleOnUpdateAuthor}
                                    onDeleteClick={props.handleOnDeleteAuthor}/>
                        )
                    }
                </li>
            )
